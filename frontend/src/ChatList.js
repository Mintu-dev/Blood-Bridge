      ...
      <div style={{ 
        ...
        {filteredChats.length === 0 ? (
          <div style={{
            ...
            <h3 style={{ color: "#666", marginBottom: "10px" }}>No Messages Yet</h3>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  boxShadow: chat.unread > 0 ? "0 2px 10px rgba(211,47,47,0.1)" : "none"
                }}
                onMouseEnter={(e) => {
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = chat.unread > 0 ? "#fff5f5" : "transparent";
